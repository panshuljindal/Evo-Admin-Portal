    ...
    <div className="main">
      ...
      <div className="right-login">
        <div className="input-box">
          ...
          <InputBox type="email" place="Email" value={email} onChange={(e) => {setEmail(e.target.value)}} logo={<HiOutlineMail fontSize="1.5rem" color="#fcfcfc" />}  />
          <InputBox type="password" place="Password" value={password} onChange={(e) => {setPassword(e.target.value)}} logo={<AiOutlineEye fontSize="1.5rem" color="#fcfcfc" />} />
          <br/>
