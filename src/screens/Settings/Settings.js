    ...
    return (
      <div className="set-container">
        ...
        <div className="middle-set">
          ...
          <div className="box">
            <ul>
              <li onClick={() => this.onPartners()}>Partners Program</li>
              <li onClick={() => this.onEvent()}>Manage Events</li>
              <li onClick={() => this.onSecurity()}>Account Security</li>
              <li onClick={() => this.onFAQ()}>F.A.Qs</li>
              <li onClick={() => this.onConnect()}>Connect With Us</li>
              <li onClick={() => this.onPrivacy()}>Privacy Policy</li>
              <li onClick={() => this.onInfo()}>Developer Info</li>
            </ul>
          </div>
        </div>
